...
//        task.main(new String[] {""});
        ...
        String mail = task.inputMail();
        int code = task.checkEmail(mail);
        task.outputMail (mail, code);
    ...
    public int checkEmail(String mailTarget){
//        final Pattern pattern = Pattern.compile("^[A-Za-z.%+\\-]+@[A-Za-z.\\-]+\\.[A-Za-z]{2,4}");
    ...
    public void outputMail(String mail, int code){
